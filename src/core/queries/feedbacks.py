...
from src.core.data_transfer_objects.paramters.queries import feedbacks as p
from src.core.data_transfer_objects.responses.queries import feedbacks as r
